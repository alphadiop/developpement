...
#templates : Un bout de texte servant de base de formatage pour représenter des données.
#Un templates aide à faire la séparation claire entre des données et leur présentation.
